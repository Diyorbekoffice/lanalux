        ...
        <div className="mx-auto container max-w-[1200px] p-6">
            ...
            <div className="flex justify-center flex-wrap gap-6">
                {woolTypes.map((wool, index) => (
                    <div 
                        key={index} 
                        className="bg-[#F0EBE780] p-1 rounded-[5px] mb-5 
                        min-w-[270px] sm:w-full md:w-[48%] lg:w-[23%] 
                        aspect-[4/3]" // Proportsional hajmni saqlash uchun
                    >
                        <div className="relative flex flex-col justify-between 
                            bg-[#F0EBE780] border-2 border-white rounded-[5px] p-6 h-full">
                            ...
                            {/* Rasm (pastki o‘ng burchakda joylashgan) */}
                            <img 
                                className="absolute bottom-4 right-4 
                                w-[40%] h-auto max-w-[135px] max-h-[144px]" 
                                src={wool.image} 
                                alt={wool.title} 
                            />
                        </div>
